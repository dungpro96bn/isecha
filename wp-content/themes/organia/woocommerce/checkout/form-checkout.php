...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', esc_html__( 'You must be logged in to checkout.', 'organia' ) ) );
	return;
}
...
<form name="checkout" method="post" class="checkout woocommerce-checkout row" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
	...
	<?php endif; ?>
        <div class="col-lg-6 col-xl-6 col-md-12">
            ...
            <h3 id="order_review_heading"><?php esc_html_e( 'Your order', 'organia' ); ?></h3>
