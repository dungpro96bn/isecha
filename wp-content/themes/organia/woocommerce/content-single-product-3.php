    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="product_details <?php if ($shop_pro_gal_style == 2): ?>pdRight<?php endif; ?>">
                ...
                <?php if (!empty($tag_terms) || $shop_pro_is_share == 1 || $shop_pro_is_sku == 1 || $shop_pro_is_tags == 1 || $shop_pro_is_cats == 1): ?>
                    <div class="pro_meta clearfix">
                        ...
                        <?php if (!empty($cat_terms) && $shop_pro_is_cats == 1): ?>
                            <div class="mtItem02">
                                <span><?php echo esc_html__('Category: ', 'organia'); ?></span><?php echo wc_get_product_category_list(get_the_ID(), ' , ') ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if ($shop_pro_is_share == 1 && !empty($shop_pro_socials)): ?>
                            <div class="mtItem02 mtsocial clearfix">
                                <span><?php echo esc_html__('Share: ', 'organia'); ?></span>
                                <?php
