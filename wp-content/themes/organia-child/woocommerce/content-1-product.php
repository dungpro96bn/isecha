...
if (is_tax('product_cat') && defined('FW')):
    ...
    if ($shop_cats_enable_con_settings == 1):
        ...
        $shop_cats_is_pricing_unit = fw_get_db_term_option($term_id, 'product_cat', 'shop_cats_is_pricing_unit', 2);
        ...
        $shop_is_pricing_unit = ($shop_cats_is_pricing_unit > 0 ? ($shop_cats_is_pricing_unit == 1 ? TRUE : FALSE) : $shop_is_pricing_unit);
...
elseif (is_tax('product_tag') && defined('FW')):
    ...
    if ($shop_tags_enable_con_settings == 1):
        ...
        $shop_tags_is_pricing_unit = fw_get_db_term_option($term_id, 'product_tag', 'shop_tags_is_pricing_unit', 2);
        ...
        $shop_is_pricing_unit = ($shop_tags_is_pricing_unit > 0 ? ($shop_tags_is_pricing_unit == 1 ? TRUE : FALSE) : $shop_is_pricing_unit);
...
$w = ($shop_thumb_width > 0 ? $shop_thumb_width : 260);
$h = ($shop_thumb_height > 0 ? $shop_thumb_height : 254);
?>
    ...
    <div <?php wc_product_class('organia_product_wrapper', $product); ?>>
        <div class="productItem01 <?php echo esc_attr($productClass); ?>">
            ...
            <div class="piActionBtns">
                ...
                <?php if ($shop_is_compare): ?>
                    <?php organia_compare_add_product_url(); ?>
                <?php endif; ?>
            </div>
            <?php echo(function_exists('organia_product_flash_notice_label') && $shop_is_flashlabels ? organia_product_flash_notice_label() : '') ?>
